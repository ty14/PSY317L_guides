...
According to Central Limit Theorem, this sampling distribution is approximately normally distributed. The mean of this sampling distribution is $\mu_{\overline{x}}=7.8$ which is the same as the population mean $\mu$. The standard deviation of this sampling distribution $\Large \sigma{\overline{x}} = \frac{\sigma}{\sqrt{n}}$.
...
$\Large CI_{95\%} = 7.95 \pm  0.152$

$\Large CI_{95\%} = 7.95 [7.798, 8.102]$
