...
If we were to rewrite that by chaining each function it would look like this, which, we think, is more human readable (at least easier to work out where you forgot to put a missing `)`):
...
Let's break down what's happening bit by bit.
