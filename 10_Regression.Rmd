...
Introduction to what regression is... predicting etc...
...
You can directly access the standardized residuals in R by using the `residuals()` function with your model output:

```{r}
df$std_resids <- residuals(mod1)
...
They are effectively the same - just transformed.
