...
For windows users, after you have clicked the appropriate linke below, you will see the following screen and you should click on  $\color{blue}{\text{"install R for the first time"}}$.
...
If you click the play arrow next to the dataframe, you can view the entire dataframe. This is the save as running the function `View(df)` (see section xxx.xxx). Another, important button is the broom icon, if you click this it will clear your global environment and you will have to rerun code to get any dataframes, function, etc. back. 
...
3. Hit `"Ctrl"+ "Shift" + "N"` on your keyboard if you have Windows, or `"Ctrl"+ "Shift" + "N"` if you have Mac. 
