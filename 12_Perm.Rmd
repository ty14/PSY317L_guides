...
With the p-value here being `p<.05`, this suggests that our data are not normally distributed. One option would be to do a non-parametric Wilcoxon-signed rank test (see section xxxx.xxx). Alternatively, we could do a permutation test.
