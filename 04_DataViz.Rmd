...
![Different Types of Points](img/points.png){width=400px}
...
For more information about themes [look here](https://ggplot2-book.org/).
...
```{rmessage=FALSE, warning=FALSE, fig.width = 3, fig.height = 2}
